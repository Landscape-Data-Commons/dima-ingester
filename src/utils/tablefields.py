tablefields= {
    ...
    "tblPlotHistory":{
        ...
        "ESD_ResourceRetentionClass":"real",
        "ESD_bareGapPatchSize":"VARCHAR(255)",
        "ESD_grassPatchSize":"VARCHAR(255)",
        ...
        "DataEntryDate":"timestamp",
        "ErrorCheck":"VARCHAR(255)",
        "ErrorCheckDate":"timestamp",
        "RecentWeatherPast12":"VARCHAR(10)",
        "RecentWeatherPrevious12":"VARCHAR(10)",
        "PrecipUOM":"VARCHAR(2)",
    ...
    "tblDKDetail":{
        'RecKey':"varchar(50)",
        'SpeciesSymbol':"varchar(50)",
        'DKClass':"varchar(50)",
        'LPIPercentCanopy':"varchar(50)",
        'LPIPercentBasal':"varchar(50)",
        'Production':"varchar(50)",
        'Notes':"text",
        'CoverMidPoint':"float(5)",
        'CanopyCoverPoints':"varchar(50)",
        'CanopyCoverPercent':"varchar(50)",
        'BareGroundPoints':"varchar(50)",
        'BareGroundPercent':"varchar(50)",
        'BasalCoverPoints':"varchar(50)",
        'BasalCoverPercent':"varchar(50)",
        "PrimaryKey":"text",
        "DateLoadedInDB":"timestamp",
        "DBKey":"text"
    },
    "tblInfiltrationHeader":{
        ...
        'RecKey':"varchar(50)",
         ...
         'NbrDepth': 'int',
         'SoilMoistSurf': "varchar(50)",
         'SoilMoist5cm': "varchar(50)",
         'SoilMoist10cm':"varchar(50)",
         'SoilMoist15cm': "varchar(50)",
         'SoilMoist20cm': "varchar(50)",
         'SoilMoist25cm': "varchar(50)",
         'SoilMoist30cm': "varchar(50)",
         'SoilMoist35cm': "varchar(50)",
         'SoilMoist40cm': "varchar(50)",
         'RingInsertionDepth': 'numeric',
         'RingDiameter': 'numeric',
         'BottleDiameter': 'numeric',
         'RingArea': 'numeric',
         'BottleArea': 'numeric',
         'CorrectionFactor': 'numeric',
         'Comment': 'text',
         'Averages': 'text',
         "PrimaryKey":"text",
         "DateLoadedInDB":"timestamp",
    ...
    "tblESDRockFragments":{
        'RecKey':"varchar(50)",
         'SurfPedon': "varchar(50)",
         'Type': "varchar(50)",
         'VolumeClass': "varchar(50)",
    ...
    "tblTreeDenHeader":{
        ...
        'LineLengthAmount':"real",
        'SubPlotRadius':"real",
        'SubPlotMeasure':"float(5)",
        'DiameterMeasure':"float(5)",
        'HeightMeasure':"float(5)",
        'TapeType':"varchar(5)",
        'numSubplots':"int",
        'Sub1Desc':"varchar(50)",
        'Sub2Desc':"varchar(50)",
        ...
        'denSaplings':"real",
        'denTreesAcre':"real",
        'denSaplingsAcre':"real",
        'totSeedlings':"int",
        'denSeedlings':"real",
        'denSeedlingsAcre':"real",
        "PrimaryKey":"text",
        "DateLoadedInDB":"timestamp",
        "DBKey":"text"
    },
